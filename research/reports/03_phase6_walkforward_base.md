...
- nulo aleatorio (100 réplicas, mismas ventanas): expectancy p50 0.021, p95 0.223; Sharpe p95 0.79

### ETHUSDT: 10 ventanas, 133 operaciones OOS
- expectancy OOS 0.144 R, t = 1.09, PF 1.28, Sharpe 0.53, DD -11.5 %
- ventanas positivas 60 %, eficiencia WF (mediana) 0.32, ventana dominante 29 % del beneficio
- nulo aleatorio (100 réplicas, mismas ventanas): expectancy p50 0.061, p95 0.253; Sharpe p95 0.88

### SOLUSDT: 5 ventanas, 51 operaciones OOS
- expectancy OOS 0.298 R, t = 1.31, PF 1.81, Sharpe 0.88, DD -5.4 %
- ventanas positivas 80 %, eficiencia WF (mediana) 0.43, ventana dominante 52 % del beneficio
- nulo aleatorio (100 réplicas, mismas ventanas): expectancy p50 0.102, p95 0.497; Sharpe p95 1.45

### Agregado (todos los símbolos)
- 309 operaciones OOS | win rate 38.2 % | avg win 1.79 R | avg loss -0.68 R | payoff 2.62
- expectancy 0.261 R | t = 2.30 (p = 0.0219) | PF 1.56 | coste/beneficio bruto 0.22
- t sobre retornos mensuales agregados: t = 2.06 (p = 0.0437, 64 meses)
- Deflated Sharpe, SR por operación 0.131. Tres supuestos sobre el número y la varianza de las pruebas:
  - conservador: M = 61, varianza entre las 57 configuraciones de todas las familias = 0.01169 → SR0 0.254, **DSR = 0.001**
  - dentro de familia: M = 61, varianza entre las 24 configuraciones de H-A1 = 0.00149 → SR0 0.091, **DSR = 0.840**
  - por familias: M = 3 familias, varianza dentro de H-A1 → SR0 0.033, **DSR = 0.992**

### Por régimen (ventanas OOS)

| trend   |   ventanas |   ops |   exp_R |   pnl_usd |   bh_ret_pct |
|:--------|-----------:|------:|--------:|----------:|-------------:|
| bear    |          5 |    44 |   0.175 |    45.816 |      -24.155 |
| bull    |         11 |   164 |   0.312 |   254.417 |      128.189 |
| lateral |          9 |   101 |   0.6   |   141.448 |       13.135 |

| vol       |   ventanas |   ops |   exp_R |   pnl_usd |
|:----------|-----------:|------:|--------:|----------:|
| vol_alta  |          5 |    72 |   0.305 |    98.27  |
| vol_baja  |          9 |   100 |   0.523 |   144.874 |
| vol_media |         11 |   137 |   0.316 |   198.538 |
...
### Nulo aleatorio agregado: expectancy p50 0.053, p95 0.382

## H-A2 · ma_momentum · 4h

### BTCUSDT: 10 ventanas, 206 operaciones OOS
- expectancy OOS 0.476 R, t = 1.85, PF 2.14, Sharpe 1.26, DD -21.5 %
- ventanas positivas 60 %, eficiencia WF (mediana) 0.62, ventana dominante 36 % del beneficio
- nulo aleatorio (100 réplicas, mismas ventanas): expectancy p50 0.087, p95 0.301; Sharpe p95 1.03

### ETHUSDT: 10 ventanas, 147 operaciones OOS
- expectancy OOS 0.633 R, t = 2.21, PF 2.21, Sharpe 1.25, DD -14.8 %
- ventanas positivas 80 %, eficiencia WF (mediana) 0.56, ventana dominante 25 % del beneficio
- nulo aleatorio (100 réplicas, mismas ventanas): expectancy p50 0.190, p95 0.506; Sharpe p95 1.30

### SOLUSDT: 5 ventanas, 121 operaciones OOS
- expectancy OOS 0.496 R, t = 1.23, PF 2.05, Sharpe 1.12, DD -16.0 %
- ventanas positivas 60 %, eficiencia WF (mediana) 0.02, ventana dominante 76 % del beneficio
- nulo aleatorio (100 réplicas, mismas ventanas): expectancy p50 0.091, p95 0.318; Sharpe p95 1.40

### Agregado (todos los símbolos)
- 474 operaciones OOS | win rate 16.7 % | avg win 5.61 R | avg loss -0.49 R | payoff 11.54
- expectancy 0.530 R | t = 3.02 (p = 0.0027) | PF 2.15 | coste/beneficio bruto 0.14
...
| trend   |   ventanas |   ops |   exp_R |   pnl_usd |   bh_ret_pct |
|:--------|-----------:|------:|--------:|----------:|-------------:|
| bear    |          5 |    77 |   0.463 |    59.407 |      -24.155 |
| bull    |         11 |   231 |   1.035 |  1346.62  |      128.189 |
| lateral |          9 |   166 |   0.266 |   267.108 |       13.135 |

| vol       |   ventanas |   ops |   exp_R |   pnl_usd |
|:----------|-----------:|------:|--------:|----------:|
| vol_alta  |          5 |    90 |   1.028 |   808.342 |
| vol_baja  |          9 |   186 |   0.098 |    36.197 |
| vol_media |         11 |   198 |   0.915 |   828.591 |
...
|   2024 |          4 |    84 |   0.369 |   218.475 |       23.843 |
...
### Nulo aleatorio agregado: expectancy p50 0.109, p95 0.390
